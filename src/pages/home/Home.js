                ...
                <div className="row">
                    <div className="col-12">
                        <div className="banner-inner">
                            ...
                            <p>Sed ut perspiciatis unde omnis iste natus error sit luptatem santium doloremque laudantium, totam rem aperiam.</p>
                            <div className="copy">
                            ...
                            <ul>
                                <li><img src="assets/images/bitcoin-(btc).svg" alt="" /></li>
                                <li><img src="assets/images/ethereum.svg" alt="" /></li>
                                <li><img src="assets/images/binance-coin-(bnb).svg" alt="" /></li>
                                <li><img src="assets/images/binance-usd-(busd).svg" alt="" /></li>
                                <li><img src="assets/images/tether-(usdt).svg" alt="" /></li>
                    ...
                    <div className="col-12">
                      <div className="custom-pets-inner">
                          <div className="custom-pets-inner-box">
                              <h2 className="heading mb-0">Custom Pet Builder ...Coming soon</h2>

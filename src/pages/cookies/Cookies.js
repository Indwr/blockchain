            ...
            <div className="col12">
              <div className="about-inner">
                <div className="about-inner-box">
                  ...
                  <p>You can lodge a complaint with a supervisory authority by contacting the Information Commissioner's Office in the UK.</p>
                  <h5>Contact Information</h5>
                  <p>If you have any questions, concerns or complaints, you can contact our privacy officer, Liam Hayne, at:</p>
                  <p>

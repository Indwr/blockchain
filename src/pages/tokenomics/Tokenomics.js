            ...
            <div className="col-12">
              <div className="tokenomics-inner">
                <div className="tokenomics-heading">
                  ...
                  <h3 className="sub-heading mb-0 turkish-lng">Tokenomik</h3>
                  ...
                  <div className="tokenomics-main-heading">
                    ...
                    <h1 className="turkish-lng"> %13 Toplam Vergi</h1>
                    ...
                    <p className="mb-0 heading-text turkish-lng">
                    Bubble Map ortaklarımıza göre: Sağlıklı bir projeye sahibiz
                    </p>
                ...
                <div className="tokenomics-content">
                  <div className="tokenomics-content-box">
                    ...
                    <p className="turkish-lng">Muhteşem sahiplerimize yeniden dağıtıldı</p>
                  ...
                  <div className="tokenomics-content-box tokenomics-content-box-bg">
                    ...
                    <p className="turkish-lng">İstikrarı korumak için Likiditeye</p>
                  ...
                  <div className="tokenomics-content-box">
                    ...
                    <p className="turkish-lng">Nakit ödüllü topluluk oyunları için PrizeFund cüzdanı</p>
                  ...
                  <div className="tokenomics-content-box">
                    ...
                    <p className="turkish-lng">Pazarlama ve Geliştirmeye Doğru</p>
                  ...
                  <div className="tokenomics-content-box">
                    ...
                    Stratejik olarak tokenları geri satın almak ve paper hands atmak için yapay zeka teknolojisi tarafından kullanılır
                    </p>

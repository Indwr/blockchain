                        ...
                        <div className="col-12">
                            <div className="tokenomics-inner">
                                ...
                                <div className="tokenomics-content">
                                    ...
                                    <div className="tokenomics-content-box">
                                        <h4>2%</h4>
                                        <p>Used by AI technology to strategically buy back tokens and kick out paper hands</p>
                                        <div className="token-box-img">
                                            <img src="assets/images/token-box-img.png" alt="" />
                                        </div>
                                    </div>
                                ...
                                <div className="tokenomics-iframe">
                                    <iframe title="tokenomicsiframe" src="https://bubbles.moonlighttoken.com/bsc/token/0x603c7f932ed1fc6575303d8fb018fdcbb0f39a95?iframe=true" />
                                </div>
